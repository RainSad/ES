...
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('1', '192.168.1.100', 'Windows', 'Chrome', 'admin', '管理员', '1', '{\"password\":[\"******\"]}', '/sys_user/updatePassword', null, '2016-12-17 15:15:37', null, '用户登录');
INSERT INTO `sys_log` VALUES ('2', '192.168.1.100', 'Windows', 'Chrome', 'admin', '管理员', '0', '{\"newPassword\":[\"12\"],\"password\":[\"******\"]}', '/sys_user/updatePassword', null, '2016-12-17 15:15:46', null, '用户登录发生异常:/ by zero');
...
CREATE TABLE `sys_user_info` (
  ...
  `remark` varchar(1000) DEFAULT NULL COMMENT '个人描述',
...
-- ----------------------------
INSERT INTO `sys_user_info` VALUES ('37c0c52095164aa4981f4aafd6a8354b', '木头', 'sunwx', null, '男', '1994-03-22', '979362142', '979362142', '15629121821', '100', '2017-8-13', null, null, '22222222222222222', '1');
...
CREATE TABLE `user` (
  `id` varchar(32) NOT NULL,
  `nick_wame` varchar(20) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for view_comment
-- ----------------------------
...
CREATE TABLE `view_comment` (
  ...
  `status` char(2) DEFAULT NULL COMMENT '状态，是否显示，0为显示，1为不显示',
  `user_id` varchar(32) DEFAULT NULL,
  KEY `id` (`id`),
  CONSTRAINT `view_comment_ibfk_1` FOREIGN KEY (`id`) REFERENCES `view_share` (`comment_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of view_comment
-- ----------------------------
INSERT INTO `view_comment` VALUES ('351289fe8de64f42888d251c1a4f5087', '2017-10-03 17:10:12', 'fdsfdsfdfdf', null, null);
INSERT INTO `view_comment` VALUES ('351289fe8de64f42888d251c1a4f5087', '2017-10-04 17:10:26', 'sfsdfsdfdsf', null, null);
INSERT INTO `view_comment` VALUES ('351289fe8de64f42888d251c1a4f5087', '2017-10-11 17:10:37', 'sdfsdfdf', null, null);

-- ----------------------------
-- Table structure for view_img_url
-- ----------------------------
DROP TABLE IF EXISTS `view_img_url`;
CREATE TABLE `view_img_url` (
  `id` varchar(32) DEFAULT NULL,
  `img_url` varchar(100) DEFAULT NULL,
  KEY `id` (`id`),
  CONSTRAINT `view_img_url_ibfk_1` FOREIGN KEY (`id`) REFERENCES `view_share` (`img_url_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of view_img_url
-- ----------------------------
INSERT INTO `view_img_url` VALUES ('351289fe8de64f42888d251c0a4f5088', '/upload/img/icon1.jpg');
INSERT INTO `view_img_url` VALUES ('351289fe8de64f42888d251c1a4f5086', '/upload/img/icon2.jpg');
INSERT INTO `view_img_url` VALUES ('351289fe8de64f42888d251c2a4f5086', '/upload/img/icon3.jpg');
INSERT INTO `view_img_url` VALUES ('351289fe8de64s42888d251c0a4f2081', '/upload/img/dex1.jpg');
INSERT INTO `view_img_url` VALUES ('351219fe8de64s42888d251c0a4f2081', '/upload/img/dex2.jpg');
INSERT INTO `view_img_url` VALUES ('351219fe8de64s42882d221c0a4f5081', '/upload/img/lunbo1.jpg');
INSERT INTO `view_img_url` VALUES ('351219fe8de64s42882d221c0a4f5081', '/upload/img/lunbo2.jpg');
INSERT INTO `view_img_url` VALUES ('351219fe8de64s42882d221c0a4f5081', '/upload/img/lunbo0.jpg');

-- ----------------------------
-- Table structure for view_share
-- ----------------------------
...
CREATE TABLE `view_share` (
  ...
  `like_num` int(11) DEFAULT NULL COMMENT '赞次数',
  `img_url_id` varchar(32) DEFAULT NULL COMMENT '图片地址',
  `title` varchar(100) DEFAULT NULL COMMENT '标题',
  `message` varchar(5000) DEFAULT NULL COMMENT '内容',
  `status` char(2) DEFAULT NULL COMMENT '状态，0为显示，1为不现实',
  `address` varchar(10) DEFAULT NULL COMMENT '地址',
  `self_evaluation` int(3) DEFAULT NULL COMMENT '自评分数',
  `other_evaluation` int(3) DEFAULT NULL COMMENT '游客评分',
  `comment_id` varchar(32) DEFAULT NULL COMMENT '评论id',
  `type` char(2) DEFAULT NULL COMMENT '分享类型，如主页轮播图还是其他，0为主页轮播，1为推荐，2为用户一般分享',
  PRIMARY KEY (`id`),
  KEY `comment_id` (`comment_id`),
  KEY `img_url` (`img_url_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of view_share
-- ----------------------------
INSERT INTO `view_share` VALUES ('351219fe8de64s42882d251c0a4f5081', null, '2017-10-20 17:28:11', null, null, '351219fe8de64s42888d251c0a4f2081', 'Oh yeah, it\'s that good. \r\nSee for yourself.', 'Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.', null, null, null, null, '351289fe8de64f42888d251c1a4f5087', '2');
INSERT INTO `view_share` VALUES ('351219fe8de64s42882d251c0a4f5082', null, '2017-10-20 17:09:43', null, null, '351219fe8de64s42882d221c0a4f5081', null, null, null, null, null, null, null, '0');
INSERT INTO `view_share` VALUES ('351219fe8de64s42888d251c0a4f5081', null, '2017-10-20 17:10:02', null, null, '351289fe8de64s42888d251c0a4f2081', 'First featurette heading. \r\nIt\'ll blow your mind.', 'Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.', null, null, null, null, '351289fe8de64f42888d251c1a4f2086', '2');
INSERT INTO `view_share` VALUES ('351289fe8de64f42888d251c0a4f5081', null, '2017-10-20 16:40:36', null, null, '351289fe8de64f42888d251c1a4f5086', 'Heading', 'Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.', null, null, null, null, null, '1');
INSERT INTO `view_share` VALUES ('351289fe8de64f42888d251c0a4f5086', null, '2017-10-20 16:40:35', null, null, '351289fe8de64f42888d251c0a4f5088', 'Heading', 'Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.', null, null, null, null, null, '1');
INSERT INTO `view_share` VALUES ('351289fe8de64s42888d251c0a4f5081', null, '2017-10-20 16:40:37', null, null, '351289fe8de64f42888d251c2a4f5086', 'Heading', 'Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.', null, null, null, null, null, '1');

-- ----------------------------
-- View structure for v_user_role_resource
-- ----------------------------
DROP VIEW IF EXISTS `v_user_role_resource`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_user_role_resource` AS select `sur`.`user_id` AS `user_id`,`sur`.`role_id` AS `role_id`,`sr`.`id` AS `id`,`sr`.`level` AS `level`,`sr`.`name` AS `name`,`sr`.`parent_id` AS `parent_id`,`sr`.`perm_code` AS `perm_code`,`sr`.`remark` AS `remark`,`sr`.`sort` AS `sort`,`sr`.`status` AS `status`,`sr`.`type` AS `type`,`sr`.`url` AS `url`,`sr`.`create_time` AS `create_time`,ifnull(`sr`.`iconCls`,'icon-hamburg-right') AS `iconCls` from ((`sys_user_role` `sur` left join `sys_role_resources` `srr` on((`sur`.`role_id` = `srr`.`role_id`))) left join `sys_resources` `sr` on((`srr`.`resources_id` = `sr`.`id`))) where (`sr`.`id` is not null) ;
